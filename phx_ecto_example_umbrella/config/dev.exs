...
config :phx_ecto_example_web, PhxEctoExampleWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "bdnTLorQhnIU02MABwrQIKfCPTzqzooexNDfCoTlCfxNtZuru9U5qf2Fo/sUEDcI",
  watchers: [
...
config :phx_ecto_example_web, PhxEctoExampleWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/phx_ecto_example_web/(live|views)/.*(ex)$",
      ~r"lib/phx_ecto_example_web/templates/.*(eex)$"
    ]
  ]
